...
import Yae
import Yae.Database.welcome_sql as sql
import Yae.Database.global_bans_sql as gban_sql
from Yae import (
...
from Yae.Handlers.misc import (
    build_keyboard,
    revert_buttons,
)
from Yae.Handlers.msg_types import get_welcome_type
...
def welcome(update: Update, context: CallbackContext):
    ...
    if not args or args[0].lower() == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text(
                "I'll go loaf around and not welcome anYae then.",
            )
